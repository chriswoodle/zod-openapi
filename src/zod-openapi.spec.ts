...
describe('zodOpenapi', () => {
  ...
  it('Elides components in its vocabulary', () => {
    ...
    const [schemas, vocabulary] = generateVocabulary([schema], '3.0');
    ...
    expect(generateSchema(z.object({nested: schema}), { vocabulary }))
      .toEqual({
        "properties": {
          "nested": {
  ...
  it('should support basic primitives for OpenAPI v3.0', () => {
    ...
    const apiSchema = generateSchema(zodSchema, {useOutput: false}, '3.0');
  ...
  it('It should support proper transform input/output', () => {
    ...
    const schemaIn = generateSchema(zodTransform) as SchemaObject;
  ...
  it('should support catch-all types', () => {
    ...
    const apiSchema = generateSchema(zodSchema) as SchemaObject;
  ...
  it('Experimentation', () => {
    ...
    const openApiSchema: SchemaObject = generateSchema(UserZ) as SchemaObject;
  ...
  it('should work with ZodTransform and correctly set nullable and optional', () => {
    ...
    const schema = z.object({
      item: extendApi(
        ...
        generateSchema(z.string().nullable()) as SchemaObject
      ),
    });
    ...
    const schema2 = z.object({
      item: extendApi(
        ...
        generateSchema(z.string()) as SchemaObject
      ),
    });
